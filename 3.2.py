...
class HashTable:
    ...
    def get(self, key):
        ...
        position = startslot
        # Пока значение ячейки ключа не является пустым списком и не найдено значение и цикл не остановлен
